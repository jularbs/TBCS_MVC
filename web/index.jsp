  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
		...
		<small style="color:red;">Username/Password incorrect</small>
		<% }%>
        ...
        <a href="forgotmypassword.jsp">I forgot my password</a><br>
        <a href="registerclient.jsp" class="text-center">Register a new membership</a>
